...
// 获得URL队列
LinkQueue.prototype.getUnVisitedUrl = function(){
  return unVisitedUrl;
};

// 添加到访问过的URL队列中
LinkQueue.prototype.addVisitedUrl = function(url){
  visitedUrl.push(url);
};

// 移除访问过的URL
LinkQueue.prototype.removeVisitedUrl = function(url){
  visitedUrl.remove(url);
};

// 未访问的URL出队列
LinkQueue.prototype.unVisitedUrlDeQueue = function(){
  return unVisitedUrl.shift();
};

// 保证每个url只被访问一次
LinkQueue.prototype.addUnVisitedUrl = function(url){
...
// 获得已经访问的URL数目
LinkQueue.prototype.getVisitedUrlNum = function(){
  return visitedUrl.length;
};

// 判断未访问的URL队列中是否为空
LinkQueue.prototype.unVisitedUrlsEmpty = function(){
